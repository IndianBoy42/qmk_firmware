...
#define KDEL(X)             X(KC_DEL,         _,             _,           LSA(KC_F),      _,          _,       KC_MINS,    RGB_RMOD)
#define KBSPC(X)            X(KC_BSPC,        _,             _,           KC_BSPC,        _,          _,       KC_PPLS,    RGB_MOD)
#define KTAB(X)             X(KC_TABNAVI,     KC_1,          _,           _,              KC_LCTL,    KC_LCTL, KC_EXLM,    KC_F1)
#define KA(X)               X(KC_A,           KC_2,          _,           KC_F17,         KC_LPRN,    KC_DLR,  KC_AT,      KC_F2)
#define KS(X)               X(KC_S,           KC_3,          _,           KC_F18,         KC_ASTR,    KC_LPRN, KC_HASH,    KC_F3)
#define KD(X)               X(KC_D,           KC_4,          _,           KC_F19,         KC_DLR,     KC_RPRN, KC_DLR,     KC_F4)
#define KF(X)               X(KC_F,           KC_5,          _,           KC_F20,         KC_PIPE,    KC_DOT,  KC_PERC,    KC_F5)
#define KG(X)               X(KC_G,           KC_6,          _,           KC_WH_D,        KC_RPRN,    KC_0,    KC_CIRC,    KC_F6)
#define KH(X)               X(KC_H,           KC_7,          _,           KC_LEFT,        KC_QUOT,    KC_4,    KC_AMPR,    KC_F7)
#define KJ(X)               X(KC_J,           KC_8,          _,           KC_DOWN,        KC_UNDS,    KC_5,    KC_ASTR,    KC_F8)
#define KK(X)               X(KC_K,           KC_9,          _,           KC_UP,          KC_EQL,     KC_6,    KC_LPRN,    KC_F9)
#define KL(X)               X(KC_L,           KC_0,          _,           KC_RGHT,        KC_BSLS,    KC_0,    KC_RPRN,    KC_F10)
#define KSCLN(X)            X(KC_SCLN,        KC_MINS,       _,           KC_NO,          _,          KC_NO,   KC_UNDS,    KC_F11)
#define KENT(X)             X(KC_ENTCMBO,     KC_EQL,        _,           LCS(KC_P),      KC_SCLN,    KC_NO,   KC_EQL,     KC_F12)
#define KLSFT(X)            X(KC_LSFT,        _,             KC_LCA,      KC_NO,          KC_ALTNUMS, _,       KC_ALTNUMS, KC_CAPS)
#define KZ(X)               X(KC_Z,           LCA(KC_Z),     _,           KC_F21,         KC_LBRC,    KC_NO,   KC_LBRC,    KC_SLCK)
#define KX(X)               X(KC_X,           LCA(KC_X),     _,           KC_F22,         KC_COLN,    KC_CIRC, KC_RBRC,    KC_NLCK)
#define KC(X)               X(KC_C,           MEH(KC_C),     _,           KC_F23,         KC_HASH,    KC_ASTR, KC_PIPE,    KC_NO)
#define KV(X)               X(KC_V,           MEH(KC_V),     _,           KC_F24,         KC_AMPR,    KC_SLSH, KC_QUOT,    RGB_SAD)
#define KB(X)               X(KC_B,           KC_QUOT,       _,           KC_NO,          KC_RBRC,    KC_NO,   KC_DQUO,    RGB_SAI)
#define KN(X)               X(KC_N,           KC_SLSH,       _,           KC_HOME,        KC_SLSH,    KC_7,    KC_SLSH,    KC_NO)
#define KM(X)               X(KC_M,           KC_LBRC,       _,           KC_PGDN,        KC_MINS,    KC_8,    KC_BSLS,    KC_NO)
#define KCOMM(X)            X(KC_COMM,        KC_RBRC,       _,           KC_PGUP,        KC_PPLS,    KC_9,    KC_LCBR,    KC_NO)
#define KDOT(X)             X(KC_DOT,         KC_BSLS,       _,           KC_END,         KC_NO,      KC_DOT,  KC_RCBR,    KC_NO)
#define KUP(X)              X(KC_UP,          KC_PGUP,       KC_SLSH,     KC_NO,          KC_PGUP,    _,       KC_PGUP,    KC_NO)
#define KMO15(X)            X(KC_KBDMGMT,     LCS(KC_P),     _,           KC_NO,          KC_NO,      _,       KC_NO,      _)
#define KLCTL(X)            X(KC_LCTL,        _,             KC_HYPR,     OSM(MOD_MEH),   _,          _,       _,          RGB_M_P)
#define KLGUI(X)            X(KC_LGUI,        _,             KC_SGUI,     _,              _,          _,       _,          RGB_M_B)
#define KLALT(X)            X(KC_LALT,        _,             KC_MEH,      _,              _,          _,       _,          RGB_M_R)
#define KSYM(X)             X(KC_ALTSYMS,     _,             KC_LCTL,     KC_LCTL,        _,          _,       _,          RGB_HUI)
#define KSPC(X)             X(KC_SPC,         KC_SPC,        KC_LCS,      KC_LSFT,        _,          KC_LSFT, _,          RGB_HUD)
#define KSSYM(X)            X(KC_ALTNUMS,     _,             KC_LCAG,     KC_NO,          _,          _,       KC_RCBR,    RGB_M_SW)
#define KLEFT(X)            X(KC_LEFT,        KC_HOME,       KC_MEH,      KC_NO,          KC_HOME,    _,       KC_HOME,    RGB_M_K)
#define KDOWN(X)            X(KC_DOWN,        KC_PGDN,       KC_SGUI,     KC_NO,          KC_PGDN,    _,       KC_PGDN,    RGB_M_X)
#define KRGHT(X)            X(KC_RGHT,        KC_END,        KC_HYPR,     KC_NO,          KC_END,     _,       KC_END,     RGB_M_G)
#define KSLSH(X)            X(KC_SLSH,        _,             _,           KC_NO,          _,          _,       _,          KC_NO)
#define KVLT(X)             X(KC_LEFT,        KC_HOME,       KC_LCAG,     KC_NO,          KC_HOME,    _,       KC_HOME,    RGB_M_SW)
#define KVDN(X)             X(KC_DOWN,        KC_PGDN,       KC_MEH,      KC_NO,          KC_PGDN,    _,       KC_PGDN,    RGB_M_K)
#define KVUP(X)             X(KC_UP,          KC_PGUP,       KC_SGUI,     KC_NO,          KC_PGUP,    _,       KC_PGUP,    RGB_M_X)
#define KVRT(X)             X(KC_RGHT,        KC_END,        KC_HYPR,     KC_NO,          KC_END,     _,       KC_END,     RGB_M_G)
