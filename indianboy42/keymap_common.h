...
#define KM(X)               X(KC_M,           KC_LBRC,       _,           KC_PGDN,        KC_MINS,    KC_7,       KC_NO)
#define KCOMM(X)            X(KC_COMM,        KC_RBRC,       _,           KC_PGUP,        KC_PPLS,    KC_8,       KC_NO)
#define KDOT(X)             X(KC_DOT,         KC_BSLS,       _,           KC_END,         KC_NO,      KC_9,       KC_NO)
...
#define KSPC(X)             X(KC_SPC,         KC_SPC,        KC_LCS,      KC_LSFT,        KC_LSFT,    _,          RGB_HUD)
