...
#define KQ(X)               X(KC_Q,           LCA(KC_Q),     _,           KC_F13,         KC_NO,      KC_NO,      KC_MUTE)
...
#define KY(X)               X(KC_Y,           LCA(KC_Y),     _,           RALT(KC_J),     KC_DQUO,    KC_NO,      RGB_TOG)
#define KU(X)               X(KC_U,           LCA(KC_U),     _,           RALT(KC_K),     KC_EXLM,    KC_7,       RGB_VAI)
#define KI(X)               X(KC_I,           LCA(KC_I),     _,           LCS(KC_TAB),    KC_QUES,    KC_8,       RGB_VAD)
#define KO(X)               X(KC_O,           LCA(KC_O),     _,           LCTL(KC_TAB),   KC_PERC,    KC_9,       RGB_SPI)
...
#define KG(X)               X(KC_G,           KC_6,          _,           KC_WH_D,        KC_RPRN,    KC_NO,      KC_F6)
#define KH(X)               X(KC_H,           KC_7,          _,           KC_LEFT,        KC_QUOT,    KC_0,       KC_F7)
#define KJ(X)               X(KC_J,           KC_8,          _,           KC_DOWN,        KC_UNDS,    KC_4,       KC_F8)
#define KK(X)               X(KC_K,           KC_9,          _,           KC_UP,          KC_EQL,     KC_5,       KC_F9)
#define KL(X)               X(KC_L,           KC_0,          _,           KC_RGHT,        KC_BSLS,    KC_6,       KC_F10)
#define KSCLN(X)            X(KC_SCLN,        KC_MINS,       _,           KC_NO,          _,          KC_0,       KC_F11)
#define KENT(X)             X(KC_ENTCMBO,     KC_EQL,        _,           LCS(KC_P),      _,          _,          KC_F12)
#define KLSFT(X)            X(KC_LSFT,        _,             KC_LCA,      KC_NO,          _,          _,          KC_CAPS)
...
#define KN(X)               X(KC_N,           KC_SLSH,       _,           KC_HOME,        KC_SLSH,    KC_NO,      KC_NO)
#define KM(X)               X(KC_M,           KC_LBRC,       _,           KC_PGDN,        KC_MINS,    KC_1,       KC_NO)
#define KCOMM(X)            X(KC_COMM,        KC_RBRC,       _,           KC_PGUP,        KC_PPLS,    KC_2,       KC_NO)
#define KDOT(X)             X(KC_DOT,         KC_BSLS,       _,           KC_END,         KC_NO,      KC_3,       KC_NO)
...
#define KSPC(X)             X(KC_SPC,         KC_SPC,        KC_LCS,      KC_LSFT,        _,          _,          RGB_HUD)
#define KSSYM(X)            X(KC_ALTNUMS,     _,             KC_LCAG,     KC_NO,          _,          _,          RGB_M_SW)
...
#define KVLT(X)             X(KC_ALTNUMS,     _,             KC_LCAG,     KC_NO,          KC_HOME,    _,          RGB_M_SW)
#define KVDN(X)             X(KC_LEFT,        KC_HOME,       KC_MEH,      KC_NO,          KC_PGDN,    _,          RGB_M_K)
#define KVUP(X)             X(KC_DOWN,        KC_PGDN,       KC_SGUI,     KC_NO,          KC_PGUP,    _,          RGB_M_X)
