...
#define KW(X)               X(KC_W,           LCA(KC_W),     _,           KC_F14,         KC_LCBR,    KC_PERC,       KC_2,       KC_F2)
...
#define KT(X)               X(KC_T,           LCA(KC_T),     _,           KC_WH_U,        KC_RCBR,    KC_NO,         KC_5,       RGB_VAI)
#define KY(X)               X(KC_Y,           LCA(KC_Y),     _,           RALT(KC_J),     KC_DQUO,    KC_1,          KC_6,       RGB_VAD)
#define KU(X)               X(KC_U,           LCA(KC_U),     _,           RALT(KC_K),     KC_CIRC,    KC_2,          KC_7,       RGB_SPD)
#define KI(X)               X(KC_I,           LCA(KC_I),     _,           LCS(KC_TAB),    KC_QUES,    KC_3,          KC_8,       KC_1)
...
#define KG(X)               X(KC_G,           KC_6,          _,           KC_WH_D,        KC_RPRN,    KC_0,          KC_CIRC,    RGB_RMOD)
#define KH(X)               X(KC_H,           KC_7,          _,           KC_LEFT,        KC_QUOT,    KC_4,          KC_AMPR,    KC_BRIU)
#define KJ(X)               X(KC_J,           KC_8,          _,           KC_DOWN,        KC_UNDS,    KC_5,          KC_ASTR,    RGB_SPI)
#define KK(X)               X(KC_K,           KC_9,          _,           KC_UP,          KC_EQL,     KC_6,          KC_LPRN,    KC_4)
#define KL(X)               X(KC_L,           KC_0,          _,           KC_RGHT,        KC_BSLS,    KC_0,          KC_RPRN,    KC_5)
#define KSCLN(X)            X(KC_SCLN,        KC_MINS,       _,           KC_NO,          _,          KC_NO,         KC_UNDS,    KC_6)
...
#define KZ(X)               X(KC_Z,           LCA(KC_Z),     _,           KC_F21,         KC_LBRC,    KC_NO,         KC_LBRC,    KC_F7)
#define KX(X)               X(KC_X,           LCA(KC_X),     _,           KC_F22,         KC_COLN,    KC_CIRC,       KC_RBRC,    KC_F8)
...
#define KB(X)               X(KC_B,           KC_QUOT,       _,           KC_NO,          KC_RBRC,    KC_NO,         KC_DQUO,    KC_F11)
#define KN(X)               X(KC_N,           KC_SLSH,       _,           KC_HOME,        KC_SLSH,    KC_7,          KC_SLSH,    KC_F12)
#define KM(X)               X(KC_M,           KC_LBRC,       _,           KC_PGDN,        KC_MINS,    KC_8,          KC_BSLS,    KC_BRID)
#define KCOMM(X)            X(KC_COMM,        KC_RBRC,       _,           KC_PGUP,        KC_PPLS,    KC_9,          KC_LCBR,    KC_7)
#define KDOT(X)             X(KC_DOT,         KC_BSLS,       _,           KC_END,         KC_NO,      KC_DOT,        KC_RCBR,    KC_8)
